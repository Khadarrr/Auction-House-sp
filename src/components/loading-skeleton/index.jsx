export default function Skeleton() {
  return (
    <div className="card-container mx-5 my-3 grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3">
      {[...Array(8)].map((_, index) => (
        <div key={index} className="card glass animate-pulse">
          <figure className="relative overflow-hidden">
            <div className="skeleton h-32 sm:h-48 md:h-56 lg:h-64 xl:h-72 w-full"></div>
          </figure>
          <div className="card-body p-4">
            ...
            <p className="card-text text-gray-700 mb-4">
              ...
              <div className="skeleton h-3 sm:h-4 w-4/6"></div>
            </p>
